# Logic Blueprint: @Owl.Editor.Rollback src/editor/rollback/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| ROLL_IDLE | saveSnapshot | snapshot.saved |
| ROLL_PENDING | scheduleRollback | error.occured |
| ROLL_EXECUTING | applyRevert | snapshot.valid |
| ROLL_COMPLETE | restoreState | state.restored |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.927040Z*
