# Logic Blueprint: @Owl.Editor.Pipeline src/editor/pipeline/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| PIPE_IDLE | receiveMutation | mutation.valid |
| PIPE_VALIDATING | validatePass | validation.ok |
| PIPE_EXECUTING | applyEdits | edits.applied |
| PIPE_ROLLBACK | revertOnError | error.occured |
| PIPE_COMMIT | finalize | pipeline.success |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.925787Z*
