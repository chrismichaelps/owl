# Logic Blueprint: @Owl.Editor.TLI src/editor/tli/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| TLI_IDLE | injectLines | lines.valid |
| TLI_INJECTING | applyPatch | patch.valid |
| TLI_VERIFYING | verifyIntegrity | sha.valid |
| TLI_COMMITTED | tliSuccess | commit.valid |
| TLI_FAILED | injectError | error != null |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.926770Z*
