# Logic Blueprint: @Owl.Commands.Parser src/commands/parser.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| PARSE_IDLE | receiveInput | input.length > 0 |
| PARSE_TOKENIZING | tokensExtracted | tokens.length > 0 |
| PARSE_PARSING | parseComplete | ast.valid |
| PARSE_VALIDATING | validateComplete | errors.length = 0 |
| PARSE_FAILED | parseError | error != null |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.916933Z*
