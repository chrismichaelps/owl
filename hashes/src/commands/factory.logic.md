...
State_ID: BigInt(0x2be9a3d7ad9eff28)
---
...
3. Include Session lifecycle and observability handlers such as `/new`, `/resume`, and `/sessions` through the same SessionMemory dependency used by `/history` and `/memory`.
