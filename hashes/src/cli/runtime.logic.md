...
7. **Expose runtime** — Return a ManagedRuntime exposing Orchestrator, CommandRegistry, SessionMemory, ToolPermissionState, routing state, pending mutations, cache, usage metrics, and MCP manager for the TUI shell.
...
- MUST NOT: Hide SessionMemory from the TUI startup path when Session resume is supported.
...
_Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.915693Z_
