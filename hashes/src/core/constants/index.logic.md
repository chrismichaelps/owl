...
2. Keep Provider routing ids, ContextCache bounds, metrics limits, UsageMetrics display coefficients, thresholds, and fallback limits centralized.
...
- **New ContextCache bound**: Add it to CACHE_CONSTANTS.
