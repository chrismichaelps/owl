...
6. For LOW, MEDIUM, and HIGH risk levels, preserve current execution behavior until the Permission seam is implemented.
7. Propagate typed results and tagged errors according to the grammar lock.
