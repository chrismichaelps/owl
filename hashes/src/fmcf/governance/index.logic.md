# Logic Blueprint: @Owl.FMCF.Governance src/fmcf/governance/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| GOV_IDLE | receiveAction | action.valid |
| GOV_VALIDATING | checkCompliance | rules.checked |
| GOV_APPROVED | actionAllowed | compliance.ok |
| GOV_REJECTED | actionBlocked | violation.found |
| GOV_LOGGING | recordEvent | audit.trail |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.907483Z*
