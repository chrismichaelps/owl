# Logic Blueprint: @Owl.FMCF.Roles.Architect src/fmcf/roles/architect.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| ARCH_IDLE | startAnalysis | task.valid |
| ARCH_ANALYZING | evaluateTopology | structure.assessed |
| ARCH_RECOMMENDING | proposeDeepening | recommendations.ready |
| ARCH_COMPLETE | archDecision | decision.made |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.906585Z*
