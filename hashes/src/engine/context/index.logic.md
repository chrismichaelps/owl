# Logic Blueprint: @Owl.Engine.Context src/engine/context/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| CTX_NEW | addVariable | name.unique |
| CTX_ACTIVE | setValue | value.valid |
| CTX_FROZEN | lockContext | lockRequested |
| CTX_MERGED | combine | other.valid |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.924726Z*
