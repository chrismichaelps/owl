# Logic Blueprint: @Owl.Engine.Memory.Schema src/engine/memory/schema.ts
...
- StoredSessionSchema defines the persisted per-Session envelope used by SessionMemoryState.sessions.
