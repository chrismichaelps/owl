# Logic Blueprint: @Owl.Tokens.Budget src/tokens/budget/index.ts

## State Machine

| State | Transition | Guard |
|-------|------------|-------|
| BUDGET_IDLE | setLimit | limit > 0 |
| BUDGET_TRACKING | consumeTokens | amount.valid |
| BUDGET_WARNING | nearLimit | tokens > limit * 0.8 |
| BUDGET_EXCEEDED | overBudget | tokens > limit |
...
*Generated by FMCF Forensic Guardian — 2026-05-14T15:58:03.925556Z*
